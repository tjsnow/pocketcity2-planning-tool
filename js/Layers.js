const LAYER_NAMES = ["grid", "terrain", "roads", "buildings", "warnings"];

/** Immutable visibility state for renderer layers. */
export class LayerState {
  constructor(values = {}) { this.values = Object.freeze(Object.fromEntries(LAYER_NAMES.map((name) => [name, values[name] !== false]))); }
