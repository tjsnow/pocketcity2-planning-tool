const DEFINITIONS = {
  ...
  "power-plant": { effectType: "power", requires: [], mode: "network", maxLevel: 1, defaultRadius: 80, label: "Power network capacity" },
  ...
  "solar-power-plant": { effectType: "power", requires: [], mode: "network", maxLevel: 1, defaultRadius: 100, label: "Power network capacity" },
  ...
  "water-treatment-plant": { effectType: "sewage", provides: ["water", "sewage"], mode: "citywide", maxLevel: 3, defaultRadius: 80, label: "Sewage capacity" },
